...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run detecting_rtp with YOLO')
    parser.add_argument('input_url', type=str, help='Input URL for detecting_rtp (e.g. rtp://192.168.2.3:9000)')
