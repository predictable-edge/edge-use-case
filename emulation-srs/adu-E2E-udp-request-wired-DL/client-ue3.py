...
if __name__ == "__main__":
    ...
    parser.add_argument('--server-port', type=int, default=10004, help='Server port number (default: 10000)')
    parser.add_argument('--listen-port', type=int, default=10005, help='Port to listen for responses (default: 10001)')
