...
void* pull_stream(void* args) {
    ...
    std::stringstream ss;
    ss <<  "/root/edge-use-case/smart-stadium-transcoding/result/video-push-pull-wo-dec-ue-srt/task" << num_pull << "/" << get_timestamp_with_ms() << "/"
       << "frame-" << index << ".log"; 
...
int main(int argc, char* argv[]) {
    if (argc < 5) {
        ...
        fprintf(stderr, "Example: %s snow-scene.mp4 \"srt://192.168.2.3:9000\" ue1 "
                "\"ue2:srt://192.168.2.2:10000\" \"ue3:srt://192.168.2.4:10001\"\n", argv[0]);
        return 1;
    }
