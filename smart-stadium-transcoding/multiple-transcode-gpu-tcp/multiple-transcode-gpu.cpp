...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < num_outputs; ++i) {
        ...
        config.log_filename = "/home/zx/edge-use-case/smart-stadium-transcoding/result/multiple-transcode-gpu-tcp/task" + std::to_string(num_outputs) + "/" + get_timestamp_with_ms() + "/"
