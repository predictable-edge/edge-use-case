...
int embed_request_info(AVPacket *packet) {
    RequestHeader request_header = getRequestHeader();
    uint8_t sei_content[32];
    int sei_content_size = 0;
    
    sei_content[sei_content_size++] = 0x06;
    sei_content[sei_content_size++] = 0x05;
    int payload_size = 16 + sizeof(RequestHeader);
    sei_content[sei_content_size++] = payload_size;
    ...
    memcpy(sei_content + sei_content_size, &request_header, sizeof(RequestHeader));
    sei_content_size += sizeof(RequestHeader);
    sei_content[sei_content_size++] = 0x80;
